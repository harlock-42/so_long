...
static	char	**get_path_name_next(char **str)
{
	str[ZERO] = ft_strdup("./sprite/zero.xpm");
	str[ONE] = ft_strdup("./sprite/one.xpm");
	str[TWO] = ft_strdup("./sprite/two.xpm");
	str[THREE] = ft_strdup("./sprite/three.xpm");
	str[FOUR] = ft_strdup("./sprite/four.xpm");
	str[FIVE] = ft_strdup("./sprite/five.xpm");
	str[SIX] = ft_strdup("./sprite/six.xpm");
	str[SEVEN] = ft_strdup("./sprite/seven.xpm");
	str[HEIGHT] = ft_strdup("./sprite/height.xpm");
	str[NINE] = ft_strdup("./sprite/nine.xpm");
	return (str);
}

static	char	**get_path_name(char **str)
{
	str = (char **)malloc((sizeof(char *) * NB_SPRITE) + 1);
	if (str == NULL)
		return (NULL);
